...
#seven-segment LED display (renamed)
...
#Buttons
#mult_btn, reset, add_btn, sub_btn, enter_btn,
#Centre, upper, left, right, down
set_property PACKAGE_PIN U18 [get_ports mult_btn]
set_property IOSTANDARD LVCMOS33 [get_ports mult_btn]
set_property PACKAGE_PIN T18 [get_ports reset]
set_property IOSTANDARD LVCMOS33 [get_ports reset]
set_property PACKAGE_PIN W19 [get_ports sub_btn]
set_property IOSTANDARD LVCMOS33 [get_ports sub_btn]
set_property PACKAGE_PIN T17 [get_ports add_btn]
set_property IOSTANDARD LVCMOS33 [get_ports add_btn]
